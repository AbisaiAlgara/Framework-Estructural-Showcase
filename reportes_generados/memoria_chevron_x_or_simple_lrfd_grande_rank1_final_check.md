...
**Fecha de generacion:** 2026-06-08 11:57:58
...
La revision toma las fuerzas de la envolvente LRFD del motor validado. Para vigas IR se revisa la flexion alrededor del eje mayor `x-x` IMCA. En el modelo OpenSees del framework, dicha demanda corresponde al momento local asociado a `Ix` IMCA. Se usa `Cb = 1.0` y `Lb` igual a la longitud entre nodos del elemento, salvo que exista una configuracion explicita.
...
| Cumplen | 152 |
| No cumplen | 0 |
| Elemento critico | 330 |
| Grupo critico | Viga_1 |
| Perfil critico | IR 203 x 31.3 |
| Combo critico | GRAV_DISEÑO |
| Mu max (kN-m) | 71.0553 |
| MR control (kN-m) | 102.1892 |
| Utilizacion flexion max | 0.695331 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| F | Fluencia | NTC-Acero 7.3.1 / 7.4.2 | Si | 115.5152 | 103.9637 | 0.683463 | Cumple |
| PLT | Pandeo lateral por flexotorsion | NTC-Acero 7.3.2 / 7.4.3 | Si | 113.5435 | 102.1892 | 0.695331 | Cumple |
| PLP | Pandeo local del patin comprimido | NTC-Acero 7.4.4 | No | 115.5152 | 103.9637 | 0.683463 | Cumple |
| PLA | Pandeo local del alma por flexion | NTC-Acero 7.5 | No | 115.5152 | 103.9637 | 0.683463 | Cumple |

#### Verificacion Resistente

| Revision | Valor |
| --- | --- |
| 8. Mn control (kN-m) | 113.5435 |
| Estado limite control | PLT |
| 9. MR = FR Mn (kN-m) | 102.1892 |
| 10. Mu / MR | 0.695331 |
| Vn (kN) | 279.3882 |
| 11. VR (kN) | 251.4494 |
| Vu / VR | 0.302732 |
| 12. Mu/MR + (Vu/VR)^2 | 0.786978 |
| Estado final | Cumple |
...
| Parametro | Valor |
| --- | --- |
| 13. Claro de deflexion asociado | DV-0102 |
| Ratio flecha | 0.226268 |
| Delta max (mm) | 4.9968 |
| Delta adm (mm) | 22.0833 |
| Estado flecha | Cumple |

#### Resumen de Diseno de Vigas IR

| Elem | Grupo | Perfil | Inciso | Mu (kN-m) | MR (kN-m) | Vu (kN) | VR (kN) | Flexion | Cortante | F+V | Estado |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 330 | Viga_1 | IR 203 x 31.3 | 7.3 | 71.0553 | 102.1892 | 76.1218 | 251.4494 | 0.695331 | 0.302732 | 0.786978 | Cumple |
| 130 | Viga_1 | IR 203 x 31.3 | 7.3 | 70.7319 | 102.1892 | 76.1855 | 251.4494 | 0.692166 | 0.302986 | 0.783966 | Cumple |
| 230 | Viga_1 | IR 203 x 31.3 | 7.3 | 70.7199 | 102.1892 | 76.1169 | 251.4494 | 0.692049 | 0.302713 | 0.783684 | Cumple |
| 430 | Viga_2 | IR 203 x 31.3 | 7.3 | 67.8248 | 102.1892 | 75.4495 | 251.4494 | 0.663718 | 0.300058 | 0.753753 | Cumple |
| 431 | Viga_2 | IR 203 x 31.3 | 7.3 | 44.8527 | 73.7541 | 20.7933 | 251.4494 | 0.608138 | 0.0826936 | 0.614977 | Cumple |
| 131 | Viga_1 | IR 203 x 31.3 | 7.3 | 43.0503 | 73.7541 | 20.0941 | 251.4494 | 0.583699 | 0.0799131 | 0.590086 | Cumple |
| 231 | Viga_1 | IR 203 x 31.3 | 7.3 | 42.9594 | 73.7541 | 20.1525 | 251.4494 | 0.582468 | 0.0801453 | 0.588891 | Cumple |
| 137 | Viga_1 | IR 203 x 31.3 | 7.3 | 59.3196 | 102.1892 | 64.1216 | 251.4494 | 0.580488 | 0.255008 | 0.645517 | Cumple |
| 337 | Viga_1 | IR 203 x 31.3 | 7.3 | 59.1787 | 102.1892 | 63.9177 | 251.4494 | 0.579109 | 0.254197 | 0.643725 | Cumple |
| 237 | Viga_1 | IR 203 x 31.3 | 7.3 | 59.0778 | 102.1892 | 63.9794 | 251.4494 | 0.578122 | 0.254443 | 0.642863 | Cumple |
| 331 | Viga_1 | IR 203 x 31.3 | 7.3 | 42.6317 | 73.7541 | 20.1380 | 251.4494 | 0.578024 | 0.0800877 | 0.584438 | Cumple |
| 437 | Viga_2 | IR 203 x 31.3 | 7.3 | 56.4663 | 102.1892 | 63.3588 | 251.4494 | 0.552567 | 0.251974 | 0.616058 | Cumple |
| 438 | Viga_2 | IR 203 x 31.3 | 7.3 | 38.1088 | 73.7541 | 17.9514 | 251.4494 | 0.516701 | 0.0713918 | 0.521798 | Cumple |
| 238 | Viga_1 | IR 203 x 31.3 | 7.3 | 36.4284 | 73.7541 | 17.3388 | 251.4494 | 0.493917 | 0.0689553 | 0.498671 | Cumple |
| 138 | Viga_1 | IR 203 x 31.3 | 7.3 | 36.3997 | 73.7541 | 17.1999 | 251.4494 | 0.493527 | 0.0684031 | 0.498206 | Cumple |
| 338 | Viga_1 | IR 203 x 31.3 | 7.3 | 36.2351 | 73.7541 | 17.3973 | 251.4494 | 0.491296 | 0.069188 | 0.496083 | Cumple |
| 150 | Viga_1 | IR 203 x 31.3 | 7.3 | 30.3805 | 63.2910 | 7.5350 | 251.4494 | 0.480013 | 0.0299662 | 0.480911 | Cumple |
| 250 | Viga_1 | IR 203 x 31.3 | 7.3 | 30.3651 | 63.2910 | 7.5317 | 251.4494 | 0.479771 | 0.0299531 | 0.480668 | Cumple |
| 350 | Viga_1 | IR 203 x 31.3 | 7.3 | 30.3504 | 63.2910 | 7.5285 | 251.4494 | 0.479538 | 0.0299405 | 0.480434 | Cumple |
| 450 | Viga_2 | IR 203 x 31.3 | 7.3 | 30.3282 | 63.2910 | 7.5238 | 251.4494 | 0.479187 | 0.0299216 | 0.480082 | Cumple |
| 452 | Viga_2 | IR 203 x 31.3 | 7.3 | 45.4799 | 102.1892 | 30.6240 | 251.4494 | 0.445056 | 0.12179 | 0.459889 | Cumple |
| 352 | Viga_1 | IR 203 x 31.3 | 7.3 | 45.4252 | 102.1892 | 30.5868 | 251.4494 | 0.444521 | 0.121642 | 0.459318 | Cumple |
| 252 | Viga_1 | IR 203 x 31.3 | 7.3 | 45.3926 | 102.1892 | 30.5652 | 251.4494 | 0.444202 | 0.121556 | 0.458978 | Cumple |
| 152 | Viga_1 | IR 203 x 31.3 | 7.3 | 45.3581 | 102.1892 | 30.5422 | 251.4494 | 0.443864 | 0.121464 | 0.458618 | Cumple |
| 149 | Viga_1 | IR 203 x 31.3 | 7.3 | 30.3785 | 102.1892 | 20.6004 | 251.4494 | 0.297277 | 0.0819268 | 0.303989 | Cumple |
| 249 | Viga_1 | IR 203 x 31.3 | 7.3 | 30.3632 | 102.1892 | 20.5901 | 251.4494 | 0.297128 | 0.0818858 | 0.303833 | Cumple |
| 349 | Viga_1 | IR 203 x 31.3 | 7.3 | 30.3487 | 102.1892 | 20.5806 | 251.4494 | 0.296986 | 0.0818478 | 0.303685 | Cumple |
| 449 | Viga_2 | IR 203 x 31.3 | 7.3 | 30.3250 | 102.1892 | 20.5636 | 251.4494 | 0.296754 | 0.0817801 | 0.303442 | Cumple |
| 153 | Viga_1 | IR 203 x 31.3 | 7.3 | 22.2266 | 102.1892 | 15.1143 | 251.4494 | 0.217504 | 0.0601088 | 0.221117 | Cumple |
| 253 | Viga_1 | IR 203 x 31.3 | 7.3 | 22.2124 | 102.1892 | 15.1049 | 251.4494 | 0.217366 | 0.0600713 | 0.220974 | Cumple |

#### Alertas

_Sin alertas de la viga critica._
